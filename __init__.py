...
class VHorrorSkill(OVOSCommonPlaybackSkill):
    ...
    def initialize(self):
        url = "https://www.youtube.com/channel/UChKvLAa0i8fe0ASFThnyGUw"
        bootstrap = "https://raw.githubusercontent.com/OpenJarbas/streamindex/main/VHorror.json"
    ...
    def search_db(self, phrase, media_type):
        ...
        if self.voc_match(phrase, "vhorror"):
